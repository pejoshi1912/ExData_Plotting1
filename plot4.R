...
with(ecdata,{
             plot(y=GlAcPo,x=(Date+Time), type='l', xlab='', ylab = "Global Active Power")
             plot(y=Vol,x=(Date+Time), type='l', xlab = 'datetime', ylab = "Voltage")
             ...
             plot(y=GlRePo,x=(Date+Time), type='l', xlab = 'datetime', ylab = "Global_Reactive_Power")
            }
